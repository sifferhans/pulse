defmodule Play.Monitoring.Probe do
  @moduledoc """
  Pure HTTP probe for a `Play.Monitoring.Monitor`. Runs one request via `Req`
  and classifies the result into `{:up | :down | :timeout | :error, attrs}`
  ready for `Play.Monitoring.record_check/1`.
  """

  alias Play.Monitoring.Monitor
