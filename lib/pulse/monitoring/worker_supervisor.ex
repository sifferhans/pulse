defmodule Pulse.Monitoring.WorkerSupervisor do
  @moduledoc """
  DynamicSupervisor that owns one `Pulse.Monitoring.Worker` per enabled monitor.
  """

  use DynamicSupervisor

  alias Pulse.Monitoring
  alias Pulse.Monitoring.{Monitor, Worker}
  ...
  def sync_all do
    ...
    running_ids =
      Registry.select(Pulse.Monitoring.WorkerRegistry, [
        {{:"$1", :_, :_}, [], [:"$1"]}
      ])
      |> MapSet.new()
